 ...
 * 免费提醒界面
 */
public class FreeRemindBackUpActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switchCompat.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if ("".equals(base) || "".equals(floatvalue)) {
                    ToastUtil.showShort(FreeRemindBackUpActivity.this, "基准价或浮动值不能为空");
                    return true;
                }

                if ((Float.parseFloat(base) - Float.parseFloat(floatvalue)) < 0) {
                    ToastUtil.showShort(FreeRemindBackUpActivity.this, "基准价不能小于浮动值");
                    return true;
                }
                return false;
            }
...
//                        imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                        ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).
                                hideSoftInputFromWindow(FreeRemindBackUpActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);


                        String sPoint = "最新价";
                        LogUtil.e(FreeRemindBackUpActivity.this, 54, dialog.getResult());
                        if (dialog.getResult() == null || "".equals(dialog.getResult())) {
                            ToastUtil.showShort(FreeRemindBackUpActivity.this, "提醒值不能为空");
                            return;
                        }
                ...
                dialog.setNegativeButton("取消", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(FreeRemindBackUpActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                    }
                });
                dialog.show();
    ...
    private void setFloatValue(){
        ...
        ToastUtil.showShort(FreeRemindBackUpActivity.this,"浮动提醒值设置成功");
    }
                        ...
                        .setPositiveButton("确定", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (reminderDao.deletePoint(app.getUserInfoBean().getUserId(),symbol, operator, value)) {
                                    ...
                                    ToastUtil.showShort(FreeRemindBackUpActivity.this, "删除成功");
                                }
                            }
